...
This NestJS application implements a comprehensive JWT-based authentication system using access and refresh tokens. The system provides secure user authentication, authorization, and token management with automatic route protection and customizable access control.
...
- 🔧 **Custom Decorators** - Convenient user data extraction
